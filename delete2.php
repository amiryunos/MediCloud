...
<body>
    ...
    <form id="decryptForm" method="post" action="delete_file.php">
        ...
        <input type="hidden" id="filebase64" name="filebase64" value="<?php echo $fileBase64 ?>" />
        <input type="hidden" id="fileId" name="fileId" value="<?php echo $fileId ?>" />
        <input type="hidden" id="fileType" name="fileType" value="<?php echo $fileContentType ?>" />
        <input type="hidden" id="md5sum" name="md5sum" value="<?php echo $md5sum ?>" />
        <button type="submit" id="DecryptButton" >Delete</button>
    ...
    <script src="backupdelete.js"></script>
